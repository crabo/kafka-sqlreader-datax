...
public class MapRecordConverter  implements RecordConvert {
  ...
  public MapRecordConverter(RecordFactory recordFactory) {
	  //return new MapRecordImpl("binlog_kafka", recordSourceId, null, null);
  }

...
public final class DBUtil {
    ...
    public static Connection getConnection(final DataBaseType dataBaseType,
        ...
        return getConnection(dataBaseType, jdbcUrl, username, password, String.valueOf(3600 * 1000));
    }
    ...
    public static Connection getConnectionWithoutRetry(final DataBaseType dataBaseType,
        ...
        return getConnectionWithoutRetry(dataBaseType, jdbcUrl, username,
                password, String.valueOf(3600 * 1000));
    }
    ...
    private static synchronized Connection connect(DataBaseType dataBaseType,
        ...
        return connect(dataBaseType, url, user, pass, String.valueOf(3600 * 1000));
    }
    ...
    private static synchronized Connection connect(DataBaseType dataBaseType,
        ...
        //ob10的处理
        if (url.startsWith(":") && dataBaseType == DataBaseType.MySql) {
            String[] ss = url.split(":");
            if (ss.length != 3) {
                throw DataXException
                        .asDataXException(
                        		GenericErrorCode.ERROR, "JDBC OB10格式错误，请联系askdatax");
            }
    ...
    private static synchronized Connection connect(DataBaseType dataBaseType,
        ...
        try {
            ...
            DriverManager.setLoginTimeout(3600*1000);
            return DriverManager.getConnection(url, prop);
        } catch (Exception e) {
            throw DataXException.asDataXException(
            		GenericErrorCode.ERROR,"connection error",e);
        }
    }
    ...
    public static List<String> getTableColumnsByConn(DataBaseType dataBaseType, Connection conn, String tableName, String basicMsg) {
        ...
        try {
            ...
            throw DataXException.asDataXException(GenericErrorCode.ERROR,queryColumnSql,null);
        } finally {
    ...
    public static Triple<List<String>, List<Integer>, List<String>> getColumnMetaData(
        ...
        try {
            ...
            throw DataXException.asDataXException(GenericErrorCode.ERROR,
    ...
    public static ResultSet query(Connection conn, String sql)
        ...
        Statement stmt = conn.createStatement(ResultSet.TYPE_FORWARD_ONLY,
                ResultSet.CONCUR_READ_ONLY);
        //默认3600 seconds
        stmt.setQueryTimeout(3600*1000);
        return query(stmt, sql);
    }
    ...
    public static void dealWithSessionConfig(Connection conn,
        ...
        switch (databaseType) {
            case Oracle:
                sessionConfig = config.getList("session",
    ...
    private static void doDealWithSessionConfig(Connection conn,
        ...
        try {
            ...
            throw DataXException
                    .asDataXException(GenericErrorCode.ERROR, String
        ...
        for (String sessionSql : sessions) {
            ...
            try {
                ...
                throw DataXException.asDataXException(
                		GenericErrorCode.ERROR, String.format(
    ...
    public static boolean asyncResultSetNext(final ResultSet resultSet, int timeout) {
        ...
        try {
            ...
            throw DataXException.asDataXException(
            		GenericErrorCode.ERROR, "异步获取ResultSet失败", e);
        }
    } */
